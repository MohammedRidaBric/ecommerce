                                        ...
                                        <form class="form" action="{{route('admin.vendors.update',$vendor -> id )}}"
                                            ...
                                            <div class="form-group">
                                                <div class="text-center">
                                                    <img
                                                        src="/{{$vendor -> logo}}"
                                                        class="rounded-circle  height-150" alt="  لوجو التجار  ">
                                                </div>
                                            </div>
                                                                ...
                                                                <optgroup label="من فضلك أختر القسم ">
                                                                    @if($categories && $categories -> count() > 0)
                                                                        @foreach($categories as $category)
                                                                            <option
                                                                                value="{{$category -> id }}" {{ ($category -> id == $vendor -> id)? 'selected':'' }} >{{$category -> name}}</option>
                                                                        @endforeach
                                                                    @endif
                                                                </optgroup>
                                                            </select>
...
@section('script')
    ...
    <script>
        ...
        function initAutocomplete() {
            var map = new google.maps.Map(document.getElementById('map'), {
                center: {lat: 35.7642313, lng: -5.818626},
                zoom: 15,
                mapTypeId: 'roadmap'
            });
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDKZAuxH9xTzD2DLY2nKSPKrgRi2_y0ejs&libraries=places&callback=initAutocomplete&language=ar&region=maroc
         async defer"></script>
@stop
